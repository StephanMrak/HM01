            ...
            if sum(riegel) == len(thislist):
                try:
                    ...
                    if len(ind) > 1:
                        ...
                        if len(mittelwert) > 1:
                            if (
                                mittelwert[0] > 0 and mittelwert[1] > 0
                            ):  # and mittelwert[2]==0 and mittelwert[3]==0 and mittelwert[4]==0:
                                if x[0] == pos_led2:
                                    x_1 = pos_led2
                                    ...
                                    x_1 = (
                                        (-y[0] * pos_led2 / (x[0] - pos_led2))
                                        + y[1] * pos_led1 / (x[1] - pos_led1)
                                ...
                                coordinates[1] = size[1] - (
                                    (y_1 - (hoehe - d_height + d_offset)) / pixelh
                                )
                                ...
                                if mittelwert[0] <= 64 and mittelwert[1] <= 64:  # zone1
                                    ...
                                    64 < mittelwert[0] <= 128 and 64 < mittelwert[1] <= 128
                                ):  # zone3
                                    ...
                                    64 < mittelwert[0] <= 128 and 128 < mittelwert[1] <= 192
                                ):  # zone4
                                    ...
                                    128 < mittelwert[0] <= 192 and 128 < mittelwert[1] <= 192
                                ):  # zone5
                                    coordinates[0] = coordinates[0] + (0.003 / pixelh)
                                    coordinates[1] = coordinates[1] - (0.015 / pixelw)
                                    print("zone 5")
                                    ...
                                    128 < mittelwert[0] <= 192 and 192 < mittelwert[1] <= 256
                                ):  # zone6
                                    coordinates[0] = coordinates[0] + (0.003 / pixelh)
                                    coordinates[1] = coordinates[1] - (0.017 / pixelw)
                                    print("zone 6")
                                    ...
                                    192 < mittelwert[0] <= 256 and 192 < mittelwert[1] <= 256
                                ):  # zone7
                                    coordinates[0] = coordinates[0] - (0.001 / pixelh)
                                    coordinates[1] = coordinates[1] - (0.012 / pixelw)
                                    print("zone 7")
