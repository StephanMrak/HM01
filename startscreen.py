def startscreen(processname, warmupqueue, activequeue):
    ...
    if hmsysteme.check_ifdebug():
        ...
        pygame.display.set_mode(
            (0, 0), pygame.locals.DOUBLEBUF | pygame.locals.OPENGL | pygame.FULLSCREEN
        )
    ...
    OpenGL.GL.glLight(
        OpenGL.GL.GL_LIGHT0, OpenGL.GL.GL_POSITION, (0, 0, 20, 0)
    ...
    while True:
        ...
        draw_text(
            "Geben Sie in Ihrem Webbrowser folgendes als URL ein: 192.168.1.1:8081  ", -4.5, -2.25
        )
